...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            PreferenceChangedEvent event = new PreferenceChangedEvent();

            event.setSortPreference(stringValue);
            RelaxAndWatchApplication.getInstance().getBus().post(event);
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        ...
        // Update Summary with the preference's current value.
        updateSummary(preference, PreferenceManager
